...
#### 1. Context-Driven Branching (with Resolvers)
...
#### 2. Component-Driven Branching (Explicit Navigation)
...
[Learn more about branching →](/guides/branching)
...
export const onboardingFlow = defineFlow({
  ...
  // Resolver for context-driven branching
  resolvers: {
    userType: (ctx) => 
...
- [**Branching Guide**](/guides/branching) - Deep dive into branching patterns
