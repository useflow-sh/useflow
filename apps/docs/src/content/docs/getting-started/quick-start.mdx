...
<Aside type="tip" title="Congratulations!">
  You now have a complete, working flow! 🎉
</Aside>
...
<Aside type="tip">
  **Try it:** Fill out the form partially, refresh the page - you'll continue exactly where you left off!
</Aside>
