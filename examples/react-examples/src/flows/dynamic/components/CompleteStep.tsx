    ...
    <Card className="w-full max-w-2xl border-0">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="rounded-lg border bg-blue-500/10 border-blue-500/20 p-4">
          ...
          <p className="text-xs text-muted-foreground">
            The same step components (AccountStep, ProfileStep, etc.) were used
            by both flows. Only the flow definition changed - the navigation
            order and which steps were included. This demonstrates how you can
            A/B test different onboarding experiences or use feature flags to
